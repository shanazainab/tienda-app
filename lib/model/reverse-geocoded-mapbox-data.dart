...
//
//     final reverseGeocodeData = reverseGeocodeDataFromJson(jsonString);

import 'dart:convert';

ReverseGeocodeData reverseGeocodeDataFromJson(String str) => ReverseGeocodeData.fromJson(json.decode(str));

String reverseGeocodeDataToJson(ReverseGeocodeData data) => json.encode(data.toJson());
...
class ReverseGeocodeData {
    ...
    factory ReverseGeocodeData.fromJson(Map<String, dynamic> json) => ReverseGeocodeData(
        type: json["type"],
