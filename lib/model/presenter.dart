  ...
  factory Presenter.fromJson(Map<String, dynamic> json) {
    ...
    try {
      presenter = Presenter(
        ...
        videos: json["videos"],
        popularVideos: json["popular_videos"] != null ? List<dynamic>.from(
            json["popular_videos"].map((x) => x)) : null,
        featuredProducts: json["featured_products"] != null ? List<
            dynamic>.from(
            json["featured_products"].map((x) => x)) : null,
