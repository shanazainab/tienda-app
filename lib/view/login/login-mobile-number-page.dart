...
class _LoginWithMobileNumberState extends State<LoginWithMobileNumber> {
    ...
    return BlocListener<LoginBloc, LoginStates>(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
              ...
              bottomNavigationBar: BlocBuilder<LoginBloc, LoginStates>(
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: RaisedButton(
                                  ...
                                  color:
                                      mobileNumberTextController.text.length !=
                                              9
                                          ? Colors.grey[200]
                                          : Color(0xff2cdab3),
                                  onPressed: () {
                                  ...
                                  child: Text("Confirm",
                                      style: TextStyle(
                                        color: mobileNumberTextController
                                                    .text.length !=
                                                9
                                            ? Colors.grey
                                            : Color(0xfff6f6f6),
  ...
  void handleLogin(AppCountry appCountry) {
    ...
    if (mobileNumberTextController.text.length < 9) {
      ...
      if (country == null) country = appCountry.chosenCountry;
