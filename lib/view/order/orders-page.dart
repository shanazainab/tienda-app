              ...
              children: <Widget>[
                ...
                ListView.builder(
                  shrinkWrap: true,
                    ...
                    itemBuilder: (BuildContext context, int subIndex) => Column(
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          OrdersDetailsPage(orders[index])),
                                );
                              },
                              child: Row(
                                ...
                                children: <Widget>[
                                  CachedNetworkImage(
                                    imageUrl:
                                       orders[index].products[subIndex].thumbnail,
                                    width: 150,
                                    height: 150,
                                    fit: BoxFit.cover,
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Text(orders[index].products[subIndex].nameEn),
                                        ...
                                        Padding(
                                          ...
                                          child: Text("AED ${orders[index].products[subIndex].price}"),
                                        ),
                                      ],
                                    ),
                                  )
