                                                            ...
                                                            children: [
                                                              Text(
                                                                snapshot
                                                                    ...
                                                                    .data
                                                                    .keys
                                                                    .toList().reversed.toList()[index]][subIndex]
                                                                    .body,
                                                                style:
                                                                TextStyle(
                                                                  fontSize:
...
//                                        body: messageTextController.text.trim(),
//                                        userId: customerId,
//                                        createdAt: new DateTime.now(),
//                                        receiverId: widget.presenter.id,
//                                      ));
...
//                                                                         fontSize:
//                                                                             16,
//                                                                         color: snapshot.data[snapshot.data.keys.toList()[index]].reversed.toList()[subIndex].receiverId ==
//                                                                                 customerId
//                                                                             ? Colors.black
//                                                                             : Colors.white,
//                                                                       ),
...
//                                                                             fontSize:
//                                                                                 10,
//                                                                             color: snapshot.data[snapshot.data.keys.toList()[index]].reversed.toList()[subIndex].receiverId == customerId
//                                                                                 ? Colors.black
//                                                                                 : Colors.white,
//                                                                           ),
//                                                                         )
