...
class AddAddressContainer extends StatefulWidget {
  final bool isEditMode;

  final DeliveryAddress deliveryAddress;

  AddAddressContainer({this.deliveryAddress, this.isEditMode});

  @override
  _AddAddressContainerState createState() => _AddAddressContainerState();
}

class _AddAddressContainerState extends State<AddAddressContainer> {
  ...
  void initState() {
    ...
    widget.deliveryAddress.apartment = "";
                        ...
                        Center(
                          child: SizedBox(
                            ...
                            child: RaisedButton(
                              onPressed: () {
                                FocusScope.of(context).unfocus();
                                if (BlocProvider.of<AddressBloc>(context).state
                                    is Loading) {
                                } else
                  ...
                  child: Card(
                    ...
                    shape: RoundedRectangleBorder(
                        side: widget.deliveryAddress.addressType == "apartment"
                            ? BorderSide(color: Color(0xff50C0A8))
                            : BorderSide.none,
              ...
              child: Column(
                children: <Widget>[
                  TextFormField(
                    ...
                    onFieldSubmitted: (_) => FocusScope.of(context).nextFocus(),
                    validator: (value) {
                      if (value.isEmpty) return 'Enter Your Building Name';
