      ...
      child: Consumer<OverlayHandlerProvider>(
        ...
        if (!overlayProvider.inFullScreenMode)
          return BlocBuilder<BottomNavBarBloc, BottomNavBarStates>(
            ...
            if (state is ChangeBottomNavBarStatusSuccess && !state.hide)
              return buildBottomBarUI(state.index);
            else if (state is Initialize)
              return buildBottomBarUI(0);
            else
              return Container();
          });
        else
                      ...
                      items: [
                        BottomNavigationBarItem(
                            icon: SvgPicture.asset(
                              "assets/svg/home.svg",
                              color:
                                  index == 0 ? Color(0xFFff2e63) : Colors.black,
                            ),
                            label: 'Home'),
                        BottomNavigationBarItem(
                            icon: Padding(
                  ...
                  child: FloatingActionButton(
                    onPressed: () {
                      BlocProvider.of<BottomNavBarBloc>(context)
                          .add(ChangeBottomNavBarState(2, false));
                    },
                    child: Padding(
