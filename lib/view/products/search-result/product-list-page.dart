...
import 'package:tienda/view/products/search-result/product-list-container.dart';
...
class ProductListPage extends StatefulWidget {
  ...
  ProductListPage(
      {this.titleInEnglish, this.titleInArabic, this.query, this.searchBody});
              ...
              child: Scaffold(
                  ...
                  appBar: AppBar(
                    title: Text(appLanguage.appLocal == Locale('en')
                        ? widget.titleInEnglish.toUpperCase()
                        : widget.titleInArabic),
