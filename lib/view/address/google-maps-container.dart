...
typedef OnSelectedDeliveryAddress = Function(DeliveryAddress deliveryAddress);

class GoogleMapsContainer extends StatefulWidget {
  final OnSelectedDeliveryAddress onSelectedDeliveryAddress;

  GoogleMapsContainer(this.onSelectedDeliveryAddress);

  @override
  _GoogleMapsContainerState createState() => _GoogleMapsContainerState();
}
                  ...
                  child: SizedBox(
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        ...
                        widget.onSelectedDeliveryAddress(deliveryAddress);
                      },
                      child: Text(
